		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Pricing Notification",
									"targetURL": "#marathonppprincingui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"marathonppprincingui-display": {
								"semanticObject": "marathonppprincingui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=marathon.pp.princingui",
									"url": sap.ui.require.toUrl("marathon/pp/princingui")
								}
							}
						}
					}

...
sap.ui.define([
	...
	"marathonpetroleum/hsc/pricingui/controller/createCust.controller",
	...
	QUnit.module("createCust Controller");
	...
	QUnit.test("Should return the values for Customer Shipto", function (assert) {
		// assert.ok(true, "this test is fine"); 
		var value = "/getF4CustomerCreate";
		assert.equal(value, "/getF4CustomerCreate", "We are getting expected value");
	});
});
